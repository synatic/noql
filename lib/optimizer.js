 ...
 * The $project is always retained because it often defines the lookup/subquery output
 * shape (e.g. a SQL SELECT list), not only aliases for later pipeline stages.
 * @param {Array<object>} lookupPipeline
 * @returns {Array<object>}
 */
