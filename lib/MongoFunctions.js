...
class AllowableFunctions {
    ...
    static _list = [
        ...
        },
        {
            ...
            type: "aggr_func",
            parse: (parameters) => {
                return { $sum: parameters[0]||parameters }
            },
        },
        {
            name: "ceiling",
        ...
        },
        {
            ...
            type: "aggr_func",
            parse: (parameters) => {
                return { $avg: parameters[0]||parameters };
            },
        },
        {
            name: "min",
            ...
            type: "aggr_func",
            parse: (parameters) => {
                return { $min: parameters[0]||parameters };
            },
        },
        {
            name: "max",
            ...
            type: "aggr_func",
            parse: (parameters) => {
                return { $max: parameters[0]||parameters };
            },
        },
        {
            name: "subtract",
    ...
    static parse(func, parameters) {
        ...
        if (typeof parameters === 'object') {
            if ( $check.array(parameters) && $check.nonEmptyArray(parameters)) {
