...
class AllowableFunctions {
     ...
     *
     * @returns {{datetime: string, varchar: string, char: string, nchar: string, time: string, decimal: string, float: string, int: string,text:string}}
     */
    ...
    static functionByNameAndType(name, type) {
        ...
        return AllowableFunctions.functionMappings.find(
            (fn) =>
                ...
                (fn.type || '').toLowerCase() === type.toLowerCase()
        );
    }
