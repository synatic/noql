...
/** @typedef {import('./types').MongoQueryFunction} MongoQueryFunction */
/**
...
class AllowableFunctions {
     ...
     * @returns {MongoQueryFunction|null}
     */
    static functionByName(name) {
        return AllowableFunctions.functionMappings.find((fn) => fn.name.toLowerCase() === name.toLowerCase());
    }

    /**
     * Gets the list of function mappings between sql and mongo
     *
     * @returns {MongoQueryFunction[]}
     */
