...
/**
 * Checks if the parameter was wrapped in $literal and if so strips it off else returns the original param
 *
 * @param {any} param The param to check
 * @returns {any} The result
 */
function stripLiteral(param) {
    return param.$literal ? param.$literal : param;
}
