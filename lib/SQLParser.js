...
const {findPotentialIndexes} = require('./findIndexes');
/**
...
class SQLParser {
    ...
    // removed for now, working on improvements
    // /**
    //  * Finds potential indexes given a query or aggregate pipeline
    //  *
    //  * @param {import('./types').ParsedQueryOrAggregate} findIndexesOn  - parsed Query or Aggregate
    //  * @param {object} [options] - the AST options
    //  * @returns {object[]}
    //  * @throws
    //  */
    // static findPotentialIndexes(findIndexesOn, options) {
    //     return findPotentialIndexes(findIndexesOn, options);
    // }
}
