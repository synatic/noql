...
function makeQueryPart(
    ...
    const getColumnNameOrVal = (queryPart) => {
        ...
        if (queryPartToUse.column) {
            ...
            // makeQueryPart historically returned unprefixed paths for query
            // matches; only normalize/$$this-prefix when includeThis is set, or
            // when the path is already a legacy $this/$$this workaround.
            if (
                includeThis ||
