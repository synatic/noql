    ...
    describe('Deep level joins', () => {
        it('should work with the errored query from powerbi', async () => {
            ...
            const fullHcp = [
                ...
                {
                    $project: {
                        'basetable0.c22': '$_.OpportunityId',
                        'basetable0.a0': '$_.AnnualLicenseRevenueUSD',
                    },
                },
                {
                    $project: {
                ...
                },
                {
                    $lookup: {
                        ...
                        as: 'inner',
                        let: {
                            outer_basetable0_c22: '$outer.basetable0.c22',
                        },
                        pipeline: [
                            {
                                $project: {
                            ...
                            {
                                $project: {
                                    OpportunityId: '$_Table.OpportunityId',
                                    Name: '$_Table.Name',
                                },
                            },
                            {
                            ...
                            },
                            {
                                $group: {
                                    _id: {
                                        semijoin1_c22: '$rows.OpportunityId',
                                        semijoin1_c151: '$rows.Name',
                                    },
                                },
                            },
                            {
                                $project: {
                                    semijoin1_c22: '$_id.semijoin1_c22',
                                    semijoin1_c151: '$_id.semijoin1_c151',
                                    _id: 0,
                                },
                            },
                            {
                ...
                {
                    $project: {
                        'basetable0.a0': '$outer.basetable0.a0',
                        semijoin1_c151: '$inner.semijoin1_c151',
                    },
                },
                {
                    $project: {
                ...
                },
                {
                    $group: {
                        _id: {
                            semijoin1_c151: '$rows.semijoin1_c151',
                        },
                        a0: {
                            $sum: {
                                $convert: {
                                    input: '$rows.basetable0.a0',
                                    to: 'decimal',
                                },
                            },
                        },
